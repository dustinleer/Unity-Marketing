...
class Woo_Widget_Component extends WP_Widget {
	...
	public function __construct() {
		...
		$this->woo_widget_componentslist['blog-posts'] = __( 'Blog Posts', 'woothemes' );

		$this->woo_widget_componentslist['page-content'] = __( 'Page Content', 'woothemes' );
		if( is_woocommerce_activated() ) {
			$this->woo_widget_componentslist['recent-products'] = __( 'Recent Products', 'woothemes' );
		}
	...
	public function widget( $args, $instance ) {
		...
		if( $instance['component'] != 'recent-products' || ( $instance['component'] == 'recent-products' && is_woocommerce_activated() ) ) {
...
/* Register the widget. */
add_action( 'widgets_init', create_function( '', 'return register_widget("Woo_Widget_Component");' ), 20 );
?>