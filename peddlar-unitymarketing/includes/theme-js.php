...
function woo_load_featured_slider_js() {
	if ( is_home() ) {
		...
		if ( $settings['featured_touchswipe'] && ($settings['featured_touchswipe'] == 'true') ) { $touchSwipe = 'true'; } else { $touchSwipe = 'false'; }
		if ( $settings['featured_hover'] && ($settings['featured_hover'] == 'true') ) { $pauseOnHover = 'true'; } else { $pauseOnHover = 'false'; }
		if ( $settings['featured_action'] && ($settings['featured_action'] == 'true') ) { $pauseOnAction = 'true'; } else { $pauseOnAction = 'false'; }
