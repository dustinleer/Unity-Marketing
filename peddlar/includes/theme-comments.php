	      	...
	      	<div id="li-comment-<?php comment_ID() ?>" class="comment_container">
	            ...
	            <div class="comment-text">
			      	...
			      	<div class="comment-head">
		                ...
		                <span class="date"><a href="<?php echo get_comment_link(); ?>" title="<?php esc_attr_e( 'Direct link to this comment', 'woothemes' ); ?>"><?php echo get_comment_date( get_option( 'date_format' ) ); ?> <?php _e( 'at', 'woothemes' ); ?> <?php echo get_comment_time( get_option( 'time_format' ) ); ?></a></span>
